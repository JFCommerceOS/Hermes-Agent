...
**Parent repo:** [github.com/JFCommerceOS/Hermes-Agent](https://github.com/JFCommerceOS/Hermes-Agent)
...
1. Try **local** model first (`bash scripts/choose-model-for-task.sh coding`).
2. If weak, escalate to **cheap API** with budget-gatekeeper.
3. If high-risk, **GPT/Claude final review** with approval.
4. Save verified answer → `save-learning-example.sh` + learning memory.
5. Add reusable patterns to RAG/skills.
6. Review budget weekly.
